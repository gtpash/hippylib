...
from .reducedHessian import ReducedHessian, NSReducedHessian
...
def modelNSVerify(model, m0, is_quadratic=False, misfit_only=False, verbose=True, eps=None):
    """
    Verify the reduced Gradient and the Hessian of a non-smooth model.
    It will produce two loglog plots of the finite difference checks for the gradient and for the Hessian.
    It will also check for symmetry of the Hessian.
    """
    if misfit_only:
